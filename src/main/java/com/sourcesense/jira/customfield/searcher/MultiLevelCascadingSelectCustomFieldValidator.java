...
/**
 * A validator for multi level cascading select custom fields. Takes into account if the user has
 * any context under which she can see the given options.
 * 
 * @since v4.0
 */
...
public class MultiLevelCascadingSelectCustomFieldValidator extends MultiSelectCustomFieldValidator implements ClauseValidator {
  ...
  public MultiLevelCascadingSelectCustomFieldValidator(final CustomField customField, final JqlSelectOptionsUtil jqlSelectOptionsUtil, final JqlOperandResolver jqlOperandResolver,
